...
#define STRING_CONFIG_H_AUTHOR "febsy" // Who made the changes.
...
#define MACHINE_UUID "c5dab316-da89-4d32-b94a-9ea74abdf820" // BQ Witbox 2 standard config
// @section extruder
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER 77  // Y offset: -front +behind [the nozzle]
#define Z_PROBE_OFFSET_FROM_EXTRUDER  -0.39  // Z offset: -below +above  [the nozzle]
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MAX_POS - 50), 10 }

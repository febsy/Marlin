...
#define DIGIPOT_MOTOR_CURRENT { 170,170,170,170,170 }   // Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_UNLOAD_RETRACT_LENGTH      60  // (mm) Unload initial retract length.
